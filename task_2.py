...
class Book:
    ...
    def __str__(self) -> str:
        """
        Возвращает строковое представление книги пользователю.
        """
        return f'Книга "{self.name}"'

    def __repr__(self) -> str:
        """
        Возвращает строку, которая дает возможность создать идентичный экземпляр книги.
        """
...
class Library:
    def __init__(self, books=None):
        """
        Инициализирует объект бибиотеки.

        :param books: список книг (пустой по умолчанию)
        """
    ...
    def get_next_book_id(self) -> int:
        ...
        :return: следующий идентификатор (целочисленный)
        """
        if not self.books:
            return 1
